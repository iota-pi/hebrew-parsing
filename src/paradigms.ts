...
export const equivalents: ParsingCondition[][] = [
  ...
  [
    { tense: 'Wayyiqtol', pgn: { person: 2, gender: 'm', number: 's' } },
    { tense: 'Wayyiqtol', pgn: { person: 3, gender: 'f', number: 's' } },
  ],
  [
    { tense: 'Wayyiqtol', pgn: { person: 3, gender: 'f', number: 'p' } },
    { tense: 'Wayyiqtol', pgn: { person: 2, gender: 'f', number: 'p' } },
  ],
]
